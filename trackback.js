...
function runTrackBack(relTrackbackRssUrl) { 
  var header = '<h3>Ç±ÇÃãLéñÇ÷ÇÃåæãy<a href="http://blog.hatena.ne.jp/my/edit?title=ÉÇÉmê\Ç∑&body=[' + document.location.href + ':embed]" target="_blank" style="float:right">åæãyÇ∑ÇÈ</a></h3>'
